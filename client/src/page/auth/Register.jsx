...
import { AiOutlineLock, AiOutlineUser, AiOutlineMail, AiOutlinePhone } from 'react-icons/ai'
import { Link, useNavigate } from 'react-router-dom'
import { useDispatch, useSelector } from 'react-redux'
import { googleLoginOrSignUp, signUpUser } from '../../redux/actions/userActions'
...
const Register = () => {
  ...
  const handleRegister = async (value) => {
    ...
    const res = await commonRequest('POST', '/auth/send-otp', { email: value.email }, appJson)
    if (res.success) {
            ...
            >
              {({ values, setFieldValue }) => (
                <Form className="space-y-6">
                  ...
                  />
                  <Button type="submit" className="h-12 w-full bg-black text-white hover:bg-black/90">
