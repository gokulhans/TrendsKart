      ...
      <section className="relative bg-[#C84332] px-4 py-12">
        <div className="container mx-auto">
          <div className="relative mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center"> {/* Added wrapper div */}
              <img
                alt="White Nike Air Force 1 Sneakers"
                className="mx-auto block" // Added block and removed default spacing
                height={400}
                width={800}
                src={HomeImg}
                style={{ verticalAlign: 'middle' }} // Removes any inline spacing
              />
